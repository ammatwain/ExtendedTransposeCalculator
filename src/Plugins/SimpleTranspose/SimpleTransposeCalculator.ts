import { ITransposeCalculator, Pitch, NoteEnum, KeyInstruction } from "opensheetmusicdisplay";
...
export class SimpleTransposeCalculator implements ITransposeCalculator {
